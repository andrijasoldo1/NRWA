...
Route::prefix('api')->group(function () {
    Route::get('/members', [MemberController::class, 'index']); // Prikaz svih članova
    Route::post('/members', [MemberController::class, 'store']); // Pohranjivanje novog člana
    Route::get('/members/{id}', [MemberController::class, 'show']); // Prikaz pojedinačnog člana
    Route::put('/members/{id}', [MemberController::class, 'update']); // Ažuriranje člana
    Route::delete('/members/{id}', [MemberController::class, 'destroy']); // Brisanje člana
